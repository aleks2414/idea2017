...
class BlocksControllerTest < ActionController::TestCase
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post :create, block: { content: @block.content, duration: @block.duration, title: @block.title, workshop_id: @block.workshop_id }
    end
  ...
  test "should update block" do
    patch :update, id: @block, block: { content: @block.content, duration: @block.duration, title: @block.title, workshop_id: @block.workshop_id }
    assert_redirected_to block_path(assigns(:block))
  end
